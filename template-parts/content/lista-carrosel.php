                ...
                <?php if (image_destaque_field('imagem_slide')): ?>
                    <li>
                        <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
                            <?= image_destaque_field('imagem_slide', 1350, 360, ['class' => 'img-fluid d-none d-md-block']); ?>
                            <?= image_destaque_field('imagem_slide', 800, 380, ['class' => 'img-fluid d-block d-md-none']); ?>
                        </a>
                    </li>
                <?php elseif (image_destaque()) : ?>
                    <li>
                        <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
                            <?= image_destaque(1350, 360, ['class' => 'img-fluid d-none d-md-block']); ?>
                            <?= image_destaque(800, 380, ['class' => 'img-fluid d-block d-md-none']); ?>
                        </a>
                    </li>
                <?php endif; ?>
            <?php endwhile; ?>
