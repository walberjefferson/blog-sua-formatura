...
(function ($) {
  ...
  win.on("load", function () {
    ...
    function formatState(state) {
      var $state = $('<span><img src="wp-content/themes/sua-formatura/demo/images/' + $.trim(state.text.toLowerCase()) + '.png" class="img-flag" /> ' + state.text + '</span>');
      return $state;
    }
    ...
    var colors = new Array([62, 220, 148], [97, 177, 35], [87, 188, 225], [48, 89, 91], [63, 207, 221], [242, 154, 50]);
    ...
    if ($element.length > 0) {
      $element.on('click', function () {
        ...
        if (!$(this).closest('.card').find('.collapse').hasClass('show')) $(this).parents('.card-header').addClass('active');
      });
    }
    /****************************
     *  Couter up  *
...
__webpack_require__(/*! G:\laragon\www\sua-formatura\wp-content\themes\sua-formatura\resources\js\custom.js */"./resources/js/custom.js");
module.exports = __webpack_require__(/*! G:\laragon\www\sua-formatura\wp-content\themes\sua-formatura\resources\sass\custom.scss */"./resources/sass/custom.scss");
